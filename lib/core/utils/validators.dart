class Validators {
  ...
  bool isValidEgyptianPhoneNumber(String? phone) {
    ...
    //   - ^\+20(1[0125]\d{8})$: numbers starting with +20 then "1" then one digit out of 0,1,2,5 and exactly 8 further digits.
    //   - ^\+200\d{8}$: numbers starting with +200 and exactly 8 further digits.
    RegExp egyptPhoneRegex = RegExp(
