...
class OffersDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WaterMark(
      ...
      appBarChild: CommonAppBarTitle(title: context.tr.translate("offer_details")),
      height: 105,
      backGroundColor: themeProvider.currentThemeData!.primaryColor,
      contentChild: Expanded(
        child: Stack(
          children: [
            offerItem.imageUrl!=null&& offerItem.imageUrl!.isNotEmpty?
           CachedNetworkImage(
              ...
              child: Container(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      Text(
                        isArabic?offerItem.titleAr??"":offerItem.title??"",
